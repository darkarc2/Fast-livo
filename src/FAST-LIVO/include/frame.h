...
class Frame : boost::noncopyable //引入boost::noncopyable实现禁止拷贝
{
public:
  ...
  /// Projects Point from unit sphere (f) in camera pixels (c).,世界上的点投影到相机像素 (c) 上。
  ...
  //高博书公式8.18，少一个fx，fy，多了个负号。三位点在相机坐标系下的变化可比矩阵,，没用到这个
